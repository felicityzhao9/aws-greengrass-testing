...
@mark.skip(
    reason=
    "TODO: Debug the case (r'wrong/topic',r'test/topic', False)"
)
...
# @mark.parametrize("resource,topic,accepted", MQTT_TEST_TOPICS)
@mark.skip(
    reason=
    "TODO: Debug the case (r'topic-A/B-suffix/+/level/#',r'topic-A/B-suffix/matchPlus/extraLevel/level/match/pound', False)"
)
